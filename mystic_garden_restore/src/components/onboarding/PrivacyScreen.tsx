      ...
      >
        ...
        >
          ...
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <p className="text-sm font-nunito text-zinc-200 leading-relaxed">
                {t("acceptTerms")}
              </p>
        ...
        <motion.button
          ...
          className={`w-full py-4 text-lg font-bold font-poppins rounded-2xl shadow-xl transition-all duration-300 transform ${
            canContinue
              ? "bg-gradient-to-r from-beauty-rose to-beauty-violet hover:from-beauty-rose/90 hover:to-beauty-violet/90 text-white hover:scale-105"
        ...
        >
          <p className="text-xs font-nunito text-zinc-400">
