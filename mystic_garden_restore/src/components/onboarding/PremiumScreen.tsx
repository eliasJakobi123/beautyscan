    ...
    <div className="h-screen flex flex-col items-center justify-center px-6 py-8">
      ...
      >
        ...
        <motion.h1
          ...
          className="text-2xl font-bold font-poppins text-white mb-2 text-center"
        >
          {t("premiumTitle")}
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-sm font-nunito text-zinc-300 text-center mb-8"
        >
          {t("premiumDesc")}
        </motion.p>
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <span className="text-sm font-nunito text-zinc-200">
                {feature}
              </span>
            </motion.div>
          ))}
        ...
        <motion.button
          ...
          onClick={onNext}
          className="w-full py-4 bg-gradient-to-r from-beauty-rose to-beauty-violet hover:from-beauty-rose/90 hover:to-beauty-violet/90 text-white text-lg font-bold font-poppins rounded-2xl shadow-xl transition-all duration-300 transform hover:scale-105 mb-4"
          whileHover={{ scale: 1.02 }}
          whileTap={{ scale: 0.98 }}
        >
          {t("startPremium")}
